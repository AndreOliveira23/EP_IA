...
y_classified = [classify_phosphorus(value) for value in tqdm(y, desc="Classifying target")]
...
disp = ConfusionMatrixDisplay(confusion_matrix=conf_matrix, display_labels=['Classe 1 ou 2', 'Classe 3 ou 4', 'Alta'])
