...
file_path = 'ecoli_stats_2020.csv'  # Update with the actual path
...
# Classify target variable based on the given ranges for ecoli concentration
...
y_classified = [classify_ecoli(value) for value in y]
...
best_k = 16  # You can choose the best k value based on the metrics
